 ...
 *
 *   node Build/Scripts/build-astryx-themes.mjs
 */
...
const SEEDS = path.join(EXT_ROOT, 'Build/Data/astryx-themes.json');
const OUT = path.join(EXT_ROOT, 'Build/Data/astryx-themes.generated.json');
...
fs.writeFileSync(OUT, JSON.stringify({
  _comment: 'GENERATED by Build/Scripts/build-astryx-themes.mjs — edit Build/Data/astryx-themes.json instead.',
  themes: generated,
...
fs.writeFileSync(REGISTRY, JSON.stringify({
  _comment: 'GENERATED by Build/Scripts/build-astryx-themes.mjs. The single source of truth for which themes exist.',
  themes: registry,
}, null, 2) + '\n');
